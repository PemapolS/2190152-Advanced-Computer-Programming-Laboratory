public abstract class PythonList {
    protected int[] array;
    protected FindMinMaxStrategy findMinMaxStrategy;
...
class SortedList extends PythonList{
    public SortedList(int[] array){
        super(array);
        sort();
        this.findMinMaxStrategy = new SortedFindMinMaxStrategy();
    }
...
class UnsortedList extends PythonList{
    public UnsortedList(int[] array){
        super(array);
        this.findMinMaxStrategy = new UnsortedFindMinMaxStrategy();
    }
    public void append(int v) {
        int[] a = new int[array.length+1];
